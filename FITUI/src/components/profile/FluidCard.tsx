...
import { LoggedFluidsResponse, Fluid } from "@/interfaces/api/health-tracker/response/logged-fluids.interface";
...
const FluidCard: React.FC<FluidCardProp> = ({ selectedDate }) => {
    ...
    const fluidEntries = useSelector((state: RootState) => state.profileSlice.fluidEntries);
